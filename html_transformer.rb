  ...
  def self.transform(lines)
    transformed_lines = lines.map do |line|
      line.gsub(%r{href="(?:/developer/)? # base of the url
          ...
          .gsub(/\/developer\/+(docs|graph-academy|sandbox|graphacademy|editions|download|use-cases|online-course|online-training|blog|books|hardware-sizing|support|learning-neo4j-book)/, '/\1')
    end
