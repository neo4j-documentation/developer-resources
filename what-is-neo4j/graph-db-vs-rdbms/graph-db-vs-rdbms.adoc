...
.Prerequisites
[abstract]
You should have looked into the link:/developer/graph-database#property-graph[property-graph model] and into link:../../build-a-graph-data-model/guide-intro-to-graph-modeling[data modeling with graphs].
