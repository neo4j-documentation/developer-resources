...
<dl class="tabs" data-tab>
  <dd class="tab-title active"><a href="#docker-3.0">Neo4j 3.0</a></dd>
  <dd class="tab-title"><a href="#docker-2.3">Neo4j 2.3</a></dd>
</dl>
++++
...
include::docker-3.0/docker-3.0.adoc[tag=get-started,leveloffset=1]

For more details, see the link:docker-3.0[Neo4j 3.0 Docker page].

[[docker-2.3]]
[.content]
=== Neo4j 2.3 Docker Image

include::docker-2.3/docker-2.3.adoc[tag=get-started,leveloffset=1]

For more details, see the link:docker-2.3[Neo4j 2.3 Docker page].
