...
The schema can be extended with custom directives and custom types that allow specific extensions of the core language.
...
include::https://github.com/neo4j-graphql/neo4j-graphql/blob/master/readme.adoc[tags=features]
