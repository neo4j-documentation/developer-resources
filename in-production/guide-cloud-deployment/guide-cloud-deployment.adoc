...
Please also see the documentation for the Neo4j link:/developer-resources/integration/docker/docker-23[version 2.3] and the new link:{opsmanual}/deployment/single-instance/docker/[3.x releases].
