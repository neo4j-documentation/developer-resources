...
* {opsmanual}/performance/#performance-tuning[Configuration & Performance,role=manual]
...
To set the value system wide you have to follow the link:{opsmanual}/deployment/#linux-open-files[instructions] for your platform.
