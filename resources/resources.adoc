...
There are a link:/books[number of books] available, the most seminal book is the 2nd edition of O"Reilly's link:/graph-databases-book[Graph Databases (free)].

* link:/graph-databases-book [O'Reilly Graph Databases by Ian Robinson, Jim Webber and Emil Eifrem (free)]
