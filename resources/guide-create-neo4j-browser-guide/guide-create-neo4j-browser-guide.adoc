...
In Neo4j 2.3 we introduced the ability to run custom "slide-shows" in the Neo4j Browser, similar to the existing `:play movie graph`.

These guides allow to provide a guided tour to a data set or use-case.
Your users can interactively read through the slide-show, execute statements to import or query the data or look at pictures, videos or other media for detailed explanations.
...
The users can interactively page through the slide-show, execute statements from `<pre/>` areas to import or query the data or look at pictures, videos or other media for detailed explanations.
