...
The Neo4j Slack group took our user community to the next level, with more than {members} people signed up of which more than 200 being active at any given time.
