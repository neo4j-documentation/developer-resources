...
This tool is used mostly through the Neo4j Desktop application and through the Neo4j Browser, so you should also know how to use the basic functionality of link:/developer/graph-platform/neo4j-desktop/[Neo4j Desktop] and link:/developer/neo4j-browser/[Neo4j Browser].
...
image:{img}apoc_install_from_proj.png[]

.At the database level:
image:{img}apoc_install_from_db1.png[]

image:{img}apoc_install_from_db2.png[]
...
* https://neo4j.com/developer/slack/[Neo4j User Slack Channel^] - join the `\#neo4j-apoc` Slack channel to ask questions and have community and Neo4j experts from around the world answer at all hours in a chat-like format.
* mailto:devrel@neo4j.com[Neo4j APOC Team Email^] - send an email to ask questions and receive answers from someone at Neo4j.
Response time varies based on availability of team members.
//* Neo4j Discourse forum - post questions and answer other users' posts in a message-based forum.
