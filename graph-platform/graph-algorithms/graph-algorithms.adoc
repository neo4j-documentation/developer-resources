...
* https://neo4j.com/docs/graph-algorithms/current/labs-algorithms/pathfinding/[Path Finding^] - these algorithms help find the shortest path or evaluate the availability and quality of routes
