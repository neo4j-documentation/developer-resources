...
The full Cypher language documentation is available in the link:{cyphermanual}/[Neo4j Cypher Manual^] together with a complete link:/docs/cypher-refcard/current/[Reference Card].
...
* link:{cyphermanual}/[Cypher Manual^]
