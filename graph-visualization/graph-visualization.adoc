...
image:{img}neo4j_browser_yelp.jpg[link="{img}neo4j_browser_yelp.jpg",role="popup-link"]
...
image:{img}neo4j_bloom_yelp.jpg[link="{img}neo4j_bloom_yelp.jpg",role="popup-link"]
