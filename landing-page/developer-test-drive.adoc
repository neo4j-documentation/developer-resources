					...
					<div class="tabs-content">
						...
						<section role="tabpanel" aria-hidden="true" class="content gexample" id="paths">
							...
							<dl class="tabs dark" data-tab role="tablist">
								...
								<dd class="tab-title" role="presentation"><a href="#node" role="tab" tabindex="0" aria-selected="false" aria-controls="node#">Node.js</a></dd>
							</dl>
...
++++
								...
								<section role="tabpanel" aria-hidden="true" class="content" id="java">
                                    <div class="row">
                                        <div class="small-8 columns">
                                            <div class="code-container">
                                                <pre style="height: 500px;"><code class="language-java"><?php $page = file_get_contents(get_template_directory() . "/includes/social-page.java.txt"); print htmlspecialchars($page); ?></code></pre>
                                            </div>
                                        </div>
                                        <div class="small-4 columns">
								...
								<section role="tabpanel" aria-hidden="true" class="content" id="python">
                                    <div class="row">
                                        <div class="small-8 columns">
                                            <div class="code-container">
                                                <pre style="height: 500px;"><code class="language-python"><?php $page = file_get_contents(get_template_directory() . "/includes/social-page.py.txt"); print htmlspecialchars($page); ?></code></pre>
                                            </div>
                                        </div>
                                        <div class="small-4 columns">
                                            <h3 class="subheader">Downloading and Installing Python</h3>
                                            <p><ol class="install-instructions">
                                                                                           <li><a href="http://py2neo.org/2.0/">Install Py2neo</a> using pip: <code>$ pip install py2neo</code></li>
                                ...
                                <section role="tabpanel" aria-hidden="true" class="content" id="node">
                                    <div class="row">
                                        <div class="small-8 columns">
                                            <div class="code-container">
                                                <pre style="height: 500px;"><code class="language-javascript"><?php $page = file_get_contents(get_template_directory() . "/includes/social-page.js.txt"); print htmlspecialchars($page); ?></code></pre>
                                            </div>
                                        </div>
                                        <div class="small-4 columns">
                                            <h3 class="subheader">Downloading and Installing Node.js</h3>
                                            <p><ol class="install-instructions">
                                                <li><a href="https://github.com/thingdom/node-neo4j/tree/v2/">Install node-neo4j</a> using npm: <code>$ npm install --save neo4j</code></li>
              ...
              <div class="tabs-content dark">
                ...
                <section role="tabpanel" aria-hidden="true" class="content" id="python">
                                    <div class="row">
                                        <div class="small-8 columns">
                                            <div class="code-container">
                                                <pre style="height: 500px;"><code class="language-python"><?php $page = file_get_contents(get_template_directory() . "/includes/network-page.py.txt"); print htmlspecialchars($page); ?></code></pre>
                                            </div>
                                        </div>
                                        <div class="small-4 columns">
                                            <h3 class="subheader">Downloading and Installing Python</h3>
                ...
                <section role="tabpanel" aria-hidden="true" class="content" id="cs">
                                ...
                                <section role="tabpanel" aria-hidden="true" class="content" id="node">
                                    <div class="row">
                                        <div class="small-8 columns">
                                            <div class="code-container">
                                                <pre style="height: 500px;"><code class="language-javascript"><?php $page = file_get_contents(get_template_directory() . "/includes/network-page.js.txt"); print htmlspecialchars($page); ?></code></pre>
                                            </div>
                                        </div>
                                        <div class="small-4 columns">
                                            <h3 class="subheader">Downloading and Installing Node.js</h3>
              ...
              <div class="tabs-content dark">
                ...
                <section role="tabpanel" aria-hidden="true" class="content" id="python">
                                    <div class="row">
                                        <div class="small-8 columns">
                                            <div class="code-container">
                                                <pre style="height: 500px;"><code class="language-python"><?php $page = file_get_contents(get_template_directory() . "/includes/fraud-page.py.txt"); print htmlspecialchars($page); ?></code></pre>
                                            </div>
                                        </div>
                                        <div class="small-4 columns">
                                            <h3 class="subheader">Downloading and Installing Python</h3>
                ...
                <section role="tabpanel" aria-hidden="true" class="content" id="cs">
                                ...
                                <section role="tabpanel" aria-hidden="true" class="content" id="node">
                                    <div class="row">
                                        <div class="small-8 columns">
                                            <div class="code-container">
                                                <pre style="height: 500px;"><code class="language-javascript"><?php $page = file_get_contents(get_template_directory() . "/includes/fraud-page.js.txt"); print htmlspecialchars($page); ?></code></pre>
                                            </div>
                                        </div>
                                        <div class="small-4 columns">
                                            <h3 class="subheader">Downloading and Installing Node.js</h3>
