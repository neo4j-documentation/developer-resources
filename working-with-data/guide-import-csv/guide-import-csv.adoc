...
For more details on this header format and the tool, see the extensive documentation in the link:{opsmanual}/deployment/#import-tool[Neo4j Manual].
...
[role=side-nav]
* link:{opsmanual}/deployment/#import-tool["Manual: Import Tool",role=docs]
