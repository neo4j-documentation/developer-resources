...
For more details on this header format and the tool, see the extensive documentation in the link:{opsmanual}/import/[Neo4j Manual] and the accompanying link:{opsmanual}/tutorial/import-tool/[tutorial].
...
[role=side-nav]
* link:{opsmanual}/import/["Manual: Import Tool",role=docs]
