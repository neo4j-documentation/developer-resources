...
The next step is to create the relationships between these nodes.
Before we can do this, however, we'll create indexes on the nodes that we've just created to ensure their quick lookup when creating relationships in the next section.
