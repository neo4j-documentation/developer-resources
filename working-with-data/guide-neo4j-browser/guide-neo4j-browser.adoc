...
.Prerequisites
[abstract]
You should have familiarized yourself with link:../what-is-neo4j/graph-database[Graph Databases] and the link:../what-is-neo4j/property-graph[Property Graph Model].
