...
A link:/developer/guide-cloud-deployment/guide-google-cloud-launcher/[guide to deploying Neo4j Causal Clusters on GCP] has been provided
to step users through the process for clusters.
