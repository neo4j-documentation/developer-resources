...
<meta name="twitter:creator" content="@mdavidallen">
<meta name="twitter:title" content="Neo4j Causal Cluster on Google Cloud Platform">
<meta name="twitter:description" content="Guide explaining how to deploy a Neo4j Enterprise Causal Cluster via Google Cloud Launcher">
<meta name="twitter:image" content="https://s3.amazonaws.com/dev.assets.neo4j.com/wp-content/uploads/neo4j-google-cloud.png">
++++
