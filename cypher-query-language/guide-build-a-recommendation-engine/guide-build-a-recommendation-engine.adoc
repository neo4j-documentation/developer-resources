...
.Prerequisites
[abstract]
You should have a basic understanding of the link:/what-is-neo4j/property-graph[property graph model]. Having link:/download[downloaded] and installed Neo4j server helps you code along with the examples. 
...
Imagine a graph like this, a few friends with their favorite restaurants, their cusines and locations.
