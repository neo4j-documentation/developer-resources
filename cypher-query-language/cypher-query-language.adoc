...
.Prerequisites
[abstract]
This is a guide for {level}. You should have familiarized yourself with link:/developer/graph-database[Graph Databases] and the link:/developer/graph-database#property-graph[Property Graph Model].
