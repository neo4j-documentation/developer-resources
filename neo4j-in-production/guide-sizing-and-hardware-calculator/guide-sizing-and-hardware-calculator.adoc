...
What hardware do your need to run your graph use-cases efficiently and what can you do to help make Neo4j fly.
...
You should know that Neo4j employs its own persistence and caching implementation for the graph data records and have seen the files on disk (`data/graph.db`) and glanced at `messages.log`
...
The blocks have different sizes to accomodate the different type of data they contain:
...
* We should have as much RAM available as possible, the more the better.
