...
We're going to use the Neo4j Cloud tool to import the football transfers graph.
...
The application is a football transfers one based on data scraped from https://www.transfermarkt.co.uk/[transfermarkt.co.uk].
