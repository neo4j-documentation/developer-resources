...
image::{img}aurabloom_activations_option.jpg[link="{img}aurabloom_activations_option.jpg",role="popup-link"]

Click on that icon, and we should see the list of activations we have.
Beneath that list is a link to add activation keys.

image::{img}aurabloom_add_key.jpg[link="{img}aurabloom_add_key.jpg",role="popup-link"]
...
image::{img}aurabloom_activations.jpg[link="{img}aurabloom_activations.jpg",role="popup-link"]
...
image::{img}desktop_add_graphapp.jpg[link="{img}desktop_add_graphapp.jpg",role="popup-link"]
...
image::{img}aura_desktop_instance.jpg[link="{img}aura_desktop_instance.jpg",role="popup-link"]
...
image::{img}launch_bloom.jpg[link="{img}launch_bloom.jpg",role="popup-link"]
...
image::{img}aurabloom_expand_node.jpg[link="{img}aurabloom_expand_node.jpg",role="popup-link"]
