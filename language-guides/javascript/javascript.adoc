...
Finally a first Neo4j driver for Meteor is available.
...
* https://atmospherejs.com/ostrio/neo4jdriver[Neo4j Connector]
* https://atmospherejs.com/ostrio/neo4jreactivity[pseudo reactive Driver]
