...
:tags: neo4j-programming, neo4j-driver, neo4j-javascript
...
The endpoint protocol and formats are explained in detail in the link:{manual}/http-api/#http-api-transactional[Neo4j Manual^].
