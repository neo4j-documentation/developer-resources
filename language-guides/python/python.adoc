...
An Object Graph Mapper built on top of the Neo4j python driver. Familiar Django style node definition with a powerful query API, thread safe and full transaction support.
