...
This Perl driver from Mark Jensen is always up to date with the latest Neo4j API developments, and it's fun to use too.
It works with Neo4j’s REST API by using Perl5 objects in a consistent, idiomatic Perl-style.  It also has a DBI-compliant wrapper - https://metacpan.org/pod/DBD::Neo4p[DBD::Neo4p]
