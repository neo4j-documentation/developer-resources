...
The http://twitter.com/neo4jrb[Neo4j.rb team] (Andreas Ronge, Brian Underwood, Chris Grigg) continued the effort and just http://neo4j.com/blog/neo4j-rb-3-0-released/[released version 3.0] in September 2014. Neo4j.rb 3.0 won a Neo4j Graphie award for "Best Community Contribution" at the 2014 GraphConnect Conference.
