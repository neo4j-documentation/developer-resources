...
Each gem fills a different need, so the choice of a gem should be based on the plans for your app and its hosting. You may also want to consider frequency of updates, versions of Neo4j supported, and size of the community. Here's a comparison chart to help make your decision. We will compare Neography, Neo4j-core, and Neo4j.rb because they are the most actively updated and support the modern versions of Neo4j.
...
| ActiveModel-complaint (Drop-in use with Ruby on Rails) | No | Yes | Yes

| Legacy Indexing Support | Yes | No | No

| Github Commits (11/25/2014) | 609 | 606 | 1974

| Github Stars (11/25/2014) | 538 | 45 | 757

| Github Contributors (11/25/2014) | 52 | 20 | 44
...
Ruby MRI with Neo4j server is go-to choice for most developers, especially if they are used to a relational, other NoSQL databases, or frameworks such as Ruby on Rails. It allows you to have separate web and database servers and allows compatibility with popular PaaSs such as Heroku. If this sounds good to you, any of the popular gems are good choices and you are free to consider whether you want a thin wrapper or the full framework experience.
...
To install: `gem install neography`
...
The http://twitter.com/neo4jrb[Neo4j.rb team] (Andreas Ronge, Brian Underwood, Chris Grigg) continued the effort and just http://neo4j.com/blog/neo4j-rb-3-0-released/[released version 3.0] in September 2014, with version 4.0 expected in late 2014. Neo4j.rb 3.0 won a Neo4j Graphie award for "Best Community Contribution" at the 2014 GraphConnect Conference.

In addition to working actively on the https://github.com/neo4jrb[Neo4jrb project], Brian and Chris are very active community members, both online on Stack Overflow and Twitter as well as in person at meetups and Neo4j events.

Both projects support accessing Neo4j in embedded mode via JRuby and server mode via MRI.

==== Neo4j-core

To install Neo4j-core: `gem install neo4j-core`
...
To install Neo4j.rb: `gem install neo4j`

The Neo4j gem, Neo4j.rb, uses Neo4j-core as an API to connect to the server and provides an ActiveRecord-like experience for use in frameworks. It adds modules allowing the creation models that look and feel very similar to those found in vanilla Ruby on Rails but with Neo4j flavor. The gem builds on Neo4j-core's foundation to streamline all aspects of node and relationship CRUD and provides an extremely advanced, intuitive, flexible DSL for generating Cypher.
...
* https://github.com/neo4jrb[Neo4jrb Team on GitHub]
