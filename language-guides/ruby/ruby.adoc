...
Each gem fills a different need, so the choice of a gem should be based on the plans for your app and its hosting. You may also want to consider frequency of updates, versions of Neo4j supported, and size of the community. Here's a comparison chart of the these three gems to help make your decision.
