...
It is a http://my-neo4j-movies-app.herokuapp.com/[simple, one-page webapp], that uses Neo4j's movie demo database (movie, actor, director) as dataset.
...
image::http://dev.assets.neo4j.com.s3.amazonaws.com/wp-content/uploads/movie_application.png[link="http://my-neo4j-movies-app.herokuapp.com/"]
