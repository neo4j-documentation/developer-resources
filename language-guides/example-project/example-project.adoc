...
You can access the source code for the different languages via the https://github.com/neo4j-contrib/developer-resources/tree/gh-pages/language-guides/[GitHub repository] for the Neo4j developer resources.
// end::intro[]
