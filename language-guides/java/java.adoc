...
image:://s3.amazonaws.com/dev.assets.neo4j.com/wp-content/uploads/2014/04/grails.png[width=200,float=right]
...
// image:://s3.amazonaws.com/dev.assets.neo4j.com/wp-content/uploads/2014/04/DataNucleus16-300.jpg[]
