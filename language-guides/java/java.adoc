...
Being implemented in Java you can use Neo4j's link:/docs/java-reference/current/javadocs/[Java APIs] also directly in your programs. 
...
Integrated *Procedures* are available within Cypher and encapsulate dedicated functionality.
Just by annotating methods with `@Procedure` and deploying the resulting jar file into your Neo4j installation, you can make new functionality easily available within the query language.

To get started we provided a https://github.com/neo4j-examples/neo4j-procedure-template[template project] and documentation the link:/docs/java-reference/current/#procedures[developer manual].

Another extension point are {}[Neo4j Server REST extensions], they encapsulate certain graph or business functionality and are available for clients to get high performance access to specific graph operations.
...
http://jexp.de/blog/2016/02/neo4j-3-0-stored-procedures/
