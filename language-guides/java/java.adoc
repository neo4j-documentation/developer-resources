...
[cols="1,4"]
|===
| icon:user[] Authors | Rickard Öberg, Michael Hunger, Stefan Armbruster and many more
| icon:gift[] Package | http://m2.neo4j.org/content/repositories/releases/org/neo4j/neo4j-jdbc/
...
image::http://dev.assets.neo4j.com.s3.amazonaws.com/wp-content/uploads/2014/04/grails.png[width=200,float=right]
...
image::http://dev.assets.neo4j.com.s3.amazonaws.com/wp-content/uploads/2014/04/clojure.png[float=right]
...
image::http://assets.neo4j.org/img/languages/scala.png[width=200,float="right"]
