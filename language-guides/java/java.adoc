...
After setting up a simple Java based Spring configuration, and annotating your `@Node-` and `@RelationshipEntity` ,
you can use `Neo4jTemplate` to access Neo4j APIs and object graph mapping functionality.
