...
The server's HTTP API is used by many other integrations, drivers or with any REST library.
...
This is great for unit testing, but also for high performance / network-free setups.
If you embed Neo4j, you can use the Neo4j Core-Java-API directly.
