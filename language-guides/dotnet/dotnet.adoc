...
Neo4j aims to have a great experience on Windows with an installer and dedicated PowerShell modules.
...
|===
| Name | Version | Author | Package | Docs | Source 
| Neo4jDotNetDriver | 1.0.0-RC2 | 
|===
...
* Author: http://twitter.com/cskardon[Chris Skardon] http://twitter.com/tathamoddie[Tatham Oddie]
* http://stackoverflow.com/questions/tagged/neo4jclient[StackOverflow]
* https://github.com/Readify/Neo4jClient/wiki[Documentation]
* {examples}/movies-dotnet-neo4jclient[Example Project]
