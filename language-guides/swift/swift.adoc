...
https://github.com/GraphStory/neo4j-ios[Theo], the Swift framework for interfacing Neo4j, is now available in it’s version 3.2.

With this version, Theo gets full support for both Swift 3 and Swift 4, Linux support, and better integration with popular package managers. This on top of features you already expect, like CRUD operations for nodes and relationships, cypher support and transaction support.
