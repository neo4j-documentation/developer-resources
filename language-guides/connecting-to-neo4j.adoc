...
This section explains the basic concepts for interacting with Neo4j and demonstrates the sample Movie Application.

.Prerequisites
[abstract]
You should be familiar with link:/developer/graph-database[graph database concepts] and the property graph model. You should have link:/download[installed Neo4j] and made yourself familiar with our link:/developer/cypher[Cypher Query language]. And you should have whatever you need for development with your stack up and running.
...
In most cases you don't want to connect to Neo4j manually but instead use a driver or connector library for your stack or programming language.
