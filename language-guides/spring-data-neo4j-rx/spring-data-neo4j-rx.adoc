...
[NOTE]
--
You can also spin up Neo4j with Docker using the following command:

[source,console,subs="verbatim,attributes"]
----
docker run --publish=7474:7474 --publish=7687:7687 -e 'NEO4J_AUTH=neo4j/secret' neo4j:{neo4j-stable-version}
----
--
