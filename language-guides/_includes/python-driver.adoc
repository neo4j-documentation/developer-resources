...
[source, python]
----
include::https://github.com/neo4j/neo4j-python-driver/raw/1.5/test/examples/hello_world_example.py[tag=hello-world-import]

include::https://github.com/neo4j/neo4j-python-driver/raw/1.5/test/examples/hello_world_example.py[tag=hello-world,indent=0]
----
