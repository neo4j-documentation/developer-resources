...
You will find the implementations for all drivers as https://github.com/neo4j-examples?query=movies[individual GitHub repositories], which you can clone and deploy directly.