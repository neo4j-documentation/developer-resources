...
[source, clike, subs=attributes]
----
include::https://github.com/neo4j/neo4j-dotnet-driver/raw/{dotnet-driver-version}/Neo4j.Driver/Neo4j.Driver.IntegrationTests/Examples.cs[tag=minimal-example-import]

include::https://github.com/neo4j/neo4j-dotnet-driver/raw/{dotnet-driver-version}/Neo4j.Driver/Neo4j.Driver.IntegrationTests/Examples.cs[tag=hello-world,indent=0]
----
