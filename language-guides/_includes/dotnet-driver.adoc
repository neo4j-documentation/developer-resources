...
[source, clike]
----
include::https://raw.githubusercontent.com/neo4j/neo4j-dotnet-driver/{dotnet-driver-version}/Neo4j.Driver/Neo4j.Driver.Tests.Integration/ExamplesAsync.cs[tag=hello-world,indent=0]
----
