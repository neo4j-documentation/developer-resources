...
image:{img}relational_model.png[title="Click to zoom", link="{img}relational_model.png", window="_blank"]
...
image:{img}relational_as_graph.png[title="Click to zoom", link="{img}relational_as_graph.png", window="_blank"]
...
image:{img}relational_graph_model.png[title="Click to zoom", link="{img}relational_graph_model.png", window="_blank"]
