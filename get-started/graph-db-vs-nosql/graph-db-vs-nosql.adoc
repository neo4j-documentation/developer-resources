...
.Key-Value Model
image:{img}key_value_model.png[500,500]
...
.Key-Value as Graph
image:{img}key_value_as_graph.png[500,500]
...
.Document Model
image:{img}document_model.png[400,400]
...
.Document as Graph
image:{img}document_as_graph.png[500,500]
