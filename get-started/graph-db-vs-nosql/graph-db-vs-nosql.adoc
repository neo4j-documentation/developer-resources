...
image:{img}key_value_model.png[500,500, title="Click to zoom", link="{img}key_value_model.png", window="_blank"]
...
.Key-Value as Graph
image:{img}key_value_as_graph.png[500,500, title="Click to zoom", link="{img}key_value_as_graph.png", window="_blank"]
...
.Document Model
image:{img}document_model.png[400,400, title="Click to zoom", link="{img}document_model.png", window="_blank"]
...
.Document as Graph
image:{img}document_as_graph.png[500,500, title="Click to zoom", link="{img}document_as_graph.png", window="_blank"]
