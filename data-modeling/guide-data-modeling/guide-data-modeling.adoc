...
image:{img}matrix_whiteboard_model1.png[]
...
image:{img}matrix_whiteboard_model2.png[]
...
image:{img}matrix_whiteboard_model3.png[]
...
image:{img}matrix_whiteboard_model4.png[]
...
image:{img}property_graph_elements.png[title="Click to zoom", link="{img}property_graph_elements.png"]
...
.Graph Model - Nodes
image:{img}modeling_johnsally_nodes.png[Extract Nodes, 500,500]
...
.Graph Model - Labels
image:{img}modeling_johnsally_labels.png[Apply labels, 500,500]
...
image:{img}modeling_johnsally_relationships.png[Discover Relationships, 500,500]
...
image:{img}modeling_johnsally_properties.png[Add properties to nodes and relationships, 500,500]
