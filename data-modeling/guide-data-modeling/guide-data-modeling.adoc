...
:img: //s3.amazonaws.com/dev.assets.neo4j.com/wp-content/uploads
...
In this case, these entities are outlined below in bold.
...
[role=side-nav]
* {manual}#graphdb-neo4j-nodes[Manual: Nodes]
* {manual}#graphdb-neo4j-labels[Manual: Labels]
* {manual}#data-modeling-examples[Manual:Data Modeling Examples]
* http://neo4j.com/graphgists/[Graph Model Examples]
