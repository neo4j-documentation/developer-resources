...
These differences were discussed in the link:/get-started/graph-db-vs-rdbms/[Concepts: RDBMS to Graph] section earlier in these guides.
...
image:{img}relational_model.png[title="Click to zoom", link="{img}relational_model.png"]
...
image:{img}relational_graph_model.png[title="Click to zoom", link="{img}relational_graph_model.png"]
...
image:{img}relational_org_chart.png[]
