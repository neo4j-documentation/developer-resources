...
image::http://docs.neo4j.org/chunked/stable/images/graphdb-nodes-overview.svg[Nodes]
...
image::http://docs.neo4j.org/chunked/stable/images/graphdb-labels.svg[Labels]
